#ifndef PLANNING_AGENT_V2_H
#define PLANNING_AGENT_V2_H
...
class PlanningAgentV2 : public IAgent
{
private:
...
public:
  PlanningAgentV2(const Map &map, int id, std::string name, sf::Color color);
  ~PlanningAgentV2();
